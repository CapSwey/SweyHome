...
<div class="gridContainer clearfix"> 
  <!-- +=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+ HEADER +=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+ -->
  <div id="header">
    <h1>Swey<span class="black">.nl</span></h1>
  </div>
  <!-- +=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+ CONTENT 1 +=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+ -->
  <div id="content1">
   ...
   <nav class="search">
	...
	<nav class="social">
      ...
      <ul class="colums">
		...
		<li><a href="https://chat.mibbit.com/?channel=%23bhd_support&server=irc.beyond-hd.me" target="_blank">BeyondHD IRC</a></li>  
      </ul>
    </nav>
  ...
  <div id="content2">
	...
	<nav class="subtitles">
	  <h2>Encode Assets</h2>
      <ul class="colums">
        <li><a href="http://www.opensubtitles.org" target="_blank">Open Subtitles</a></li>
  ...
  <div id="content5">
	...
	<h2>Personal Sites</h2>
      <ul class="colums">
		...
		<li><a href="http://www.bridgeinnamsterdam.com" target="_blank">Bridge Inn</a></li>
  ...
  <div id="content6">
	...
	<h2>Webdesign</h2>
      <ul class="colums">
        ...
        <li><a href="http://html-color-codes.info/" target="_blank">HTML Color Codes</a></li>
        <li><a href="http://www.bluevertigo.com.ar/" target="_blank">Blue Vertigo</a></li> 
